...
sqlx migrate run --database-url postgresql://postgres:postgres@localhost:5432/ev_platform
...
docker exec -it bornemap-postgres psummary -U postgres -d ev_platform -f db/seeds/dev_chargers.sql
```
