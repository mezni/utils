...
| Authentication (OAuth2/JWT) | Not in scope for Sprint 1.3 (Sprint 2.x), focus on core functionality |
...
- Driver profiles, favorites, reviews (Sprint 2.x)
- Admin endpoints (Sprint 1.4)
