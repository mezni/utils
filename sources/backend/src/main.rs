...
fn configure_routes(cfg: &mut web::ServiceConfig) {
    cfg.service(health)
        ...
        .route("/api/v1/chargers/{id}", web::get().to(domain::chargers::handlers::get_charger))
        .route("/api/v1/chargers/{id}", web::patch().to(domain::chargers::handlers::update_charger))
        .route("/api/v1/chargers/{id}", web::delete().to(domain::chargers::handlers::delete_charger))
