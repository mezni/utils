...
const navItems = [
  ...
  { to: '/partners', label: 'Partners', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
  { to: '/stations', label: 'Stations', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
...
export function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <aside
        className={`fixed top-14 left-0 z-30 h-[calc(100svh-3.5rem)] w-64 border-r border-[var(--color-border-muted)] bg-[var(--color-surface-base)] transition-transform duration-200 ${
